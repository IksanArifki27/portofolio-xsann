...
export function SEO({
  ...
  const ogTitle = `${title} | ${isHomepage ? 'Information Enginner' : 'Iksan Arifki'}`;
  ...
  return (
    <Head>
      ...
      <meta name='author' content='M. iksan arifki' />
      ...
      <meta name='twitter:site' content='@ArifkiIksan' />
      <meta name='twitter:creator' content='@ArifkiIksan' />
      ...
      <meta property='og:site_name' content='iksanarifki.me' />
      <meta property='og:determiner' content='auto' />
      {article ? (
        <>
          <meta property='og:type' content='article' />
          <meta property='og:section' content='Programming' />
          <meta property='article:author' content='M. iksan arifki' />
