...
export default function Home({
  ...
  return (
    <main className='grid gap-20'>
      <SEO
        title='Iksan '
        description='An online portfolio and blog by M. iksan arifki. Showcase some of my past projects and some of my thoughts on the world of web development.'
      />
      <section className='-mt-20 grid min-h-screen content-center'>
        ...
        >
          <Accent>Informatics Engineering</Accent>
        </motion.h2>
...
const socialLink: SocialLink[] = [
  {
    name: 'Resume',
    href: 'https://drive.google.com/file/d/1GVks0TKVCdfC63u4rx8zHlasRQJbVwR7/view?usp=sharing',
    Icon: HiDocumentText
  },
  {
    name: 'LinkedIn',
